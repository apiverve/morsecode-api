...
```gradle
dependencies {
    implementation 'com.github.apiverve:morsecode-api:1.1.14'
}
```
...
```java
import com.apiverve.morsecode.MorseCodeAPIClient;
import com.apiverve.morsecode.APIResponse;
import com.apiverve.morsecode.APIException;

// Initialize the client
MorseCodeAPIClient client = new MorseCodeAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "This Is A Message");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/morsecode](https://docs.apiverve.com/ref/morsecode)
...
- **Documentation:** [https://docs.apiverve.com/ref/morsecode](https://docs.apiverve.com/ref/morsecode)
- **Issues:** [GitHub Issues](https://github.com/apiverve/morsecode-api/issues)
