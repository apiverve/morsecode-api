...
// Request contains the parameters for the Morse Code API.
//
// Parameters:
...
type Request struct {
	Audio bool `json:"audio,omitempty"` // Optional
...
// ResponseData contains the data returned by the Morse Code API.
