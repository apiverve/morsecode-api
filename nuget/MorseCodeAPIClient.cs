...
namespace APIVerve.API.MorseCode
{
    ...
    /// <summary>
    /// Client for the MorseCode API
    /// </summary>
    public class MorseCodeAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/morsecode";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "audio", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public MorseCodeAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MorseCodeAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MorseCodeAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MorseCodeQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MorseCodeQueryOptions options)
        {
        ...
        public ResponseObj Execute(MorseCodeQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MorseCodeQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MorseCodeQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MorseCodeQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MorseCodeQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MorseCodeQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MorseCodeQueryOptions options)
        {
