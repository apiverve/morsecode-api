...
class morsecodeWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/morsecode');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"audio":{"type":"boolean","required":false,"default":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/morsecode`);
        }
    }
...
module.exports = morsecodeWrapper;
